...
namespace MyEshopPhone.Infra.Data.Migrations
{
    ...
    [Migration("20260227154559_AddNewTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyEshop_Phone.Domain.Model._CodePostal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyEshop_Phone.Domain.Model._SmsOtpRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyEshop_Phone.Domain.Model._SubmenuGroups", b =>
                {
                    ...
                    b.Property<int>("Products_GroupsId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Products_GroupsId");

                    b.ToTable("submenuGroups");
                });
            ...
            modelBuilder.Entity("MyEshop_Phone.Domain.Model._SubmenuGroups", b =>
                {
                    b.HasOne("MyEshop_Phone.Domain.Model._Products_Groups", "groups")
                        .WithMany("submenuGroups")
                        .HasForeignKey("Products_GroupsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
